    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
    {
    	if (cmd.getName().equalsIgnoreCase("mobkills") && sender instanceof Player) {
    		if(args.length == 0)
            {
    			...
    			File configFile = new File(configGetter.getDataFolder(), player.getUniqueId() + ".yml");
    			FileConfiguration f = YamlConfiguration.loadConfiguration(configFile);
				player.sendMessage(ChatColor.GOLD + "=============== [MobStatz] your mob kills Page 1 ===============");
				player.sendMessage("" + ChatColor.GOLD + /*THIS IS WHERE I WANT TO GET THE INT PLZ HELP*/"" + ChatColor.GREEN + " Zombies " + ChatColor.GOLD + "have been killed by you!");
				player.sendMessage("" + ChatColor.GOLD + f.getInt("creeper kills") + ChatColor.GREEN + " Skeletons " + ChatColor.GOLD + "have been killed by you!");
				player.sendMessage("" + ChatColor.GOLD + f.getInt("skeleton kills") + ChatColor.GREEN + " Creepers " + ChatColor.GOLD + "have been killed by you!");
				...
				player.sendMessage("" + ChatColor.GOLD + f.getInt("Elder_Guardians kills") + ChatColor.GREEN + " Elder Guardians " + ChatColor.GOLD + "have been killed by you!");
